...
fluid_plugins_app_Application.__name__ = true;
fluid_plugins_app_Application.prototype = {
	...
	,start: function(rendererType,parentDom) {
		...
		this.stage = new fluid_core_display_Container();
		...
		if(rendererType == "auto") this.renderer = Fluid.autoDetectRenderer(this.width,this.height,renderingOptions); else if(rendererType == "canvas") this.renderer = new PIXI.CanvasRenderer(this.width,this.height,renderingOptions); else this.renderer = new fluid_core_renderers_webgl_WebGLRenderer(this.width,this.height,renderingOptions);
...
var demo_Main = function() {
	...
	this._bunny = new fluid_core_sprites_Sprite(fluid_core_textures_Texture.fromImage("bunny.png"));
	this.stage.addChild(this._bunny);
};
demo_Main.__name__ = true;
