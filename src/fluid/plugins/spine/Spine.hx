...
extern class Spine extends Container {
	...
	/**
	 * A class that enables the you to import and run your spine animations in fluid.
	 * The Spine animation data needs to be loaded using either the Loader or a SpineLoader before it can be used by this class
	 * See example 12 (http://www.goodboydigital.com/fluid.s/examples/12/) to see a working example and check out the source
	 *
	 * ```js
