...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("adi", "main", "com.arm.demo", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.arm.demo.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.arm.demo.Main, Reflect.field (com.arm.demo.Main, "main"), []);
...
@:keep class DocumentClass extends com.arm.demo.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "demo", null, { width: 0, height: 0 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.arm.demo.Main, []);
			}
