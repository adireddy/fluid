...
{
HX_STACK_FRAME("com.arm.demo.Bunny","new",0x78ecbeec,"com.arm.demo.Bunny.new","com/arm/demo/Bunny.hx",13,0x2b6c2d43)
HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.arm.demo.Bunny"), hx::TCanCast< Bunny_obj> ,sStaticFields,sMemberFields,
