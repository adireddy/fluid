...
::String Capabilities_obj::get_language( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_language",0x261e3d8b,"openfl._v2.system.Capabilities.get_language","openfl/_v2/system/Capabilities.hx",25,0x994bdadb)
	HX_STACK_LINE(27)
	::String locale = ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_language();		HX_STACK_VAR(locale,"locale");
	HX_STACK_LINE(29)
...
Float Capabilities_obj::get_pixelAspectRatio( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_pixelAspectRatio",0x7dd97b60,"openfl._v2.system.Capabilities.get_pixelAspectRatio","openfl/_v2/system/Capabilities.hx",71,0x994bdadb)
	HX_STACK_LINE(71)
	return ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_pixel_aspect_ratio();
}
...
Float Capabilities_obj::get_screenDPI( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_screenDPI",0x17095ebe,"openfl._v2.system.Capabilities.get_screenDPI","openfl/_v2/system/Capabilities.hx",72,0x994bdadb)
	HX_STACK_LINE(72)
	return ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_screen_dpi();
}
...
Array< ::Dynamic > Capabilities_obj::get_screenResolutions( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_screenResolutions",0x998a5228,"openfl._v2.system.Capabilities.get_screenResolutions","openfl/_v2/system/Capabilities.hx",75,0x994bdadb)
	HX_STACK_LINE(77)
	Array< int > res = ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_screen_resolutions();		HX_STACK_VAR(res,"res");
	HX_STACK_LINE(79)
	if (((res == null()))){
		HX_STACK_LINE(81)
...
Float Capabilities_obj::get_screenResolutionX( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_screenResolutionX",0x998a520d,"openfl._v2.system.Capabilities.get_screenResolutionX","openfl/_v2/system/Capabilities.hx",98,0x994bdadb)
	HX_STACK_LINE(98)
	return ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_screen_resolution_x();
}
...
Float Capabilities_obj::get_screenResolutionY( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_screenResolutionY",0x998a520e,"openfl._v2.system.Capabilities.get_screenResolutionY","openfl/_v2/system/Capabilities.hx",99,0x994bdadb)
	HX_STACK_LINE(99)
	return ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_screen_resolution_y();
}
...
Array< ::Dynamic > Capabilities_obj::get_screenModes( ){
	HX_STACK_FRAME("openfl._v2.system.Capabilities","get_screenModes",0x365ab551,"openfl._v2.system.Capabilities.get_screenModes","openfl/_v2/system/Capabilities.hx",101,0x994bdadb)
	HX_STACK_LINE(102)
	Array< int > modes = ::openfl::_v2::system::Capabilities_obj::lime_capabilities_get_screen_modes();		HX_STACK_VAR(modes,"modes");
	HX_STACK_LINE(103)
	Array< ::Dynamic > out = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(out,"out");
	HX_STACK_LINE(105)
	if (((modes == null()))){
	...
	HX_STACK_LINE(109)
	{
		...
		while((true)){
			...
			int c = (_g1)++;		HX_STACK_VAR(c,"c");
			HX_STACK_LINE(110)
			::openfl::_v2::system::ScreenMode mode = ::openfl::_v2::system::ScreenMode_obj::__new();		HX_STACK_VAR(mode,"mode");
			HX_STACK_LINE(111)
			...
			HX_STACK_LINE(114)
			::openfl::_v2::system::PixelFormat _g2 = ::Type_obj::createEnumIndex(hx::ClassOf< ::openfl::_v2::system::PixelFormat >(),modes->__get(((c * (int)4) + (int)3)),null());		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(114)
			mode->format = _g2;
			HX_STACK_LINE(115)
			out->push(mode);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.system.Capabilities"), hx::TCanCast< Capabilities_obj> ,sStaticFields,sMemberFields,
...
{
	lime_capabilities_get_pixel_aspect_ratio= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_pixel_aspect_ratio"),(int)0);
	lime_capabilities_get_screen_dpi= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_dpi"),(int)0);
	lime_capabilities_get_screen_resolution_x= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolution_x"),(int)0);
	lime_capabilities_get_screen_resolution_y= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolution_y"),(int)0);
	lime_capabilities_get_screen_resolutions= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolutions"),(int)0);
	lime_capabilities_get_screen_modes= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_modes"),(int)0);
	lime_capabilities_get_language= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_language"),(int)0);
}
